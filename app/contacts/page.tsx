  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid sm:grid-cols-2 gap-6 mb-10">
        <a href="https://t.me/Shpargalochka_bot" target="_blank" rel="noopener noreferrer" className="block p-8 rounded-2xl border border-gray-100 hover:border-violet-200 hover:shadow-md transition-all text-center">
          ...
          <span className="text-violet-700 font-semibold">@Shpargalochka_bot</span>
        </a>
        <a href="mailto:support@shpargalochka.org.ua" className="block p-8 rounded-2xl border border-gray-100 hover:border-violet-200 hover:shadow-md transition-all text-center">
          ...
          <span className="text-violet-700 font-semibold">support@shpargalochka.org.ua</span>
        </a>
      </div>
